 ...
 *
 */
public class MO1minTest extends Test{
	...
	public MO1minTest(Context context, EventHandler handler, String tag) {
		...
		// TODO Auto-generated method stub
		 switch(msg.what)
	     {
	        case EVENT_START_TEST:
	            {
	            	AutoStressLogger.detailLogging(MainActivity.LOG_TAG, "Start MO1min test Cycle: " + (mCycle+1));
	            	AutoStressLogger.writeLog(mContext,"Start MO1min test Cycle: " + (mCycle+1));
	            	//start PhoneSerice
	...
	{
		AutoStressLogger.detailLogging(MainActivity.LOG_TAG, "Set idel time: " + mIdle);
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver()
    {
        public void onReceive(Context arg0, Intent intent)
        {
        	...
        	else if(intent.getAction().equals(PhoneService.FAIL_BROADCAST))
        	{
        		...
        		AutoStressLogger.detailLogging(MainActivity.LOG_TAG,"<MO1minTest> [Fail] Drop Call");
        		AutoStressLogger.writeLog(mContext, "<MO1minTest> [Fail] Drop Call");
        		((TestService)mContext).stopSelf();
        		alertDialog(mContext,"<MO1minTest>\r\n [Fail] Drop Call");
        	}
        }
    };
