...
/**
 * Auto Reboot- every 2 min, 10 trials
 */
public class Reboot2minTest extends Test{
	...
	public Reboot2minTest(Context context, EventHandler handler, String tag) {
        ...
        case EVENT_START_TEST:
            {
            	...
            	{	            	
            		AutoStressLogger.detailLogging(MainActivity.LOG_TAG, "Start Reboot2minTest Cycle: " + (mCycle+1));
            		AutoStressLogger.writeLog(mContext,"Start Reboot2minTest Cycle: " + (mCycle+1));
            		mCycle++;
