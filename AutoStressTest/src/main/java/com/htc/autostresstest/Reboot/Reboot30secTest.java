...
/**
 * Auto Reboot- every 30 sec, 10 trials
 */
public class Reboot30secTest extends Test{
	...
	public Reboot30secTest(Context context, EventHandler handler, String tag) {
        ...
        case EVENT_START_TEST:
            {
            	...
            	{	            	
            		AutoStressLogger.detailLogging(MainActivity.LOG_TAG, "Start Reboot30secTest Cycle: " + (mCycle+1));
            		AutoStressLogger.writeLog(mContext,"Start Reboot30secTest Cycle: " + (mCycle+1));
            		mCycle++;
	...
	{
		Log.i(MainActivity.LOG_TAG, "set idle time:"+mSleepTime);
