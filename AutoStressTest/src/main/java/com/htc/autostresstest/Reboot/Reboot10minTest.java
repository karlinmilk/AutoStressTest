...
/**
 * Auto Reboot- every 10 min, 4 trials
 */
public class Reboot10minTest extends Test{
	...
	public Reboot10minTest(Context context, EventHandler handler, String tag) {
        ...
        case EVENT_START_TEST:
            {
            	...
            	{	            	
            		AutoStressLogger.detailLogging(MainActivity.LOG_TAG, "Start Reboot10minTest Cycle: " + (mCycle+1));
            		AutoStressLogger.writeLog(mContext,"Start Reboot10minTest Cycle: " + (mCycle+1));
            		mCycle++;
